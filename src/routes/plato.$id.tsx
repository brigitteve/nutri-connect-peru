...
import { ArrowLeft, Crown, Heart, Plus } from "lucide-react";
    ...
    <div className="min-h-screen bg-background pb-32">
      <div className="mx-auto max-w-md">
        <div className="relative aspect-square">
          ...
          <button className="absolute top-5 right-5 flex h-10 w-10 items-center justify-center rounded-full bg-background/90 backdrop-blur shadow">
        ...
        <div className="px-5 pt-5">
          ...
          {/* Ingredientes */}
          <h2 className="mt-6 font-bold">Ingredientes</h2>
      ...
      <div className="fixed inset-x-0 bottom-0 z-50 border-t border-border bg-card/95 backdrop-blur px-5 py-3">
        <div className="mx-auto max-w-md flex items-center gap-3">
          ...
          <Link
            to="/reservar"
            search={{ dish: dish.id }}
            className="flex-1 rounded-full gradient-premium py-3.5 text-center text-sm font-bold text-primary-foreground shadow-glow"
          >
            {dish.premium ? "Reservar plato a medida" : "Agregar al plan"}
          </Link>
        </div>
      </div>
    </div>
